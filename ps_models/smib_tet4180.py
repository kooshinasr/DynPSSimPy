...
def load():
    return {
        ...
        'generators': {
                ...
                ['G1',      'B1',   50,       10,    40,  0.9331671,    3.1,          0,     1.05,   0.66,    0.328,       0.66,       0.254,      0.273,       2.49,        100,        0.06,       0.15],
                ['IB',      'B3',   50,  245,     0,   0.898,          999999.,    0,      1.8,    1.8,    0.3,       0.3,        0.2,        0.2,        6.67,       6.67,       0.15,       0.15],
            ]
        },
        'gov': {
            'TGOV1': [
