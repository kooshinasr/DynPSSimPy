# A version of Nordic 44, including Automatic Generation Control (AGC) activated between some buses
...
def load():
    return {
        ...
        'gov': {
            ...
            # Seems like one need governors at generators equipped with AGC
            'TGOV1': [
        ...
        'ace': {
            ...
            'ACE_FIRST': [
                ...
                ['ACE1', 'G7000-1', '7000', '7100',         200,   0.000,  0.01,    0.05],
                ['ACE2', 'G7000-2', '7000', '7100',         200,   0.000,  0.01,    0.05],
                ['ACE3', 'G7000-3', '7000', '7100',         200,   0.000,  0.01,    0.05],
                ['ACE4', 'G7000-4', '7000', '7100',         200,   0.000,  0.01,    0.05],
                ['ACE5', 'G7000-5', '7000', '7100',         200,   0.000,  0.01,    0.05],
                ['ACE6', 'G7000-6', '7000', '7100',         200,   0.000, 0.01, 0.05],

                ['ACE11', 'G7100-1', '7100', '7000',        200,   0.000, 0.01, 0.1],
                ['ACE12', 'G7100-2', '7100', '7000',        200, 0.000, 0.01, 0.1],
                ['ACE13', 'G7100-3', '7100', '7000',        200, 0.000, 0.01, 0.1],
            ]
        },
    }